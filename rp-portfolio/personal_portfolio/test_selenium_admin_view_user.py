...
def test_view_list_of_registered_users():
    ...
    assert  'Select user to change | RP Portfolio' == driver.title and row_count >= 1
    driver.close()
...
def test_view_admin_user():
    ...
    assert  'Change user | RP Portfolio' == driver.title and 'admin' == usernametxtbox and 'http://127.0.0.1:8000/admin/auth/user/2/change/' == driver.current_url
    driver.close()
